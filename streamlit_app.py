...
TRANSACTION LINE ITEM EXTRACTION - CRITICAL COMPLETENESS REQUIREMENTS:
    ...
    - Extract all transaction line items from the bank statement 
    -The transaction line item will have the date, description, credit, debit or amount and may or may not be balance.
    -The transactions will be present ion various types of deposits and withdrawal sections
    -DO NOT MISS ANY TRANSACTION LINE ITEM FROM THE BANK STATEMENT.
